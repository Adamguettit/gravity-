...
//  Created by Adam.G 
// Sept-27-2018
//  This code calculates how high will the person be in each seconds afrer jumping from 100 meters.
...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionLabel.text = "calculates how high will the person be in each seconds afrer jumping from 100 meters."
        view.addSubview(instructionLabel)
        
        seconds = UILabel(frame: CGRect(x: 80, y: 200, width: 500, height: 50))
        ...
        secondsTextField.placeholder = "In seconds   "
    ...
    @objc func calculateAreaAndPerimeter() {
        ...
        heightLabel.text = "The height is: \(height) m"
